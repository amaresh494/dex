...
func (s *Server) handleTokenOnBehalf(w http.ResponseWriter, r *http.Request, client storage.Client) {
	...
	if ccConnector, ok := conn.Connector.(connector.OnBehalfConnector); ok {
		newIdent, err := ccConnector.HandleOnBehalf(r)
		if err != nil {
